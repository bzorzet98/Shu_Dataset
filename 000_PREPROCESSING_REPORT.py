...
for participant in participants:
    figure_path="Preprocessing_Figures/"+participant+"/"
    tables_path="Preprocessing_Tables/"+participant+"/"
    #Cargamos las tablas
    ...
    #Generamos el report
    report=Report("Reports_Preprocessing/Preprocessing_Report_"+participant+".pdf")
